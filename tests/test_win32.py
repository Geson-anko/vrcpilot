...
class TestGetWindowRect:
    ...
    def test_supports_negative_origin(self, mocker: MockerFixture):
    ...
    def test_returns_none_when_hwnd_destroyed(self, mocker: MockerFixture):
    ...
    def test_returns_none_on_degenerate_rect(
        self, mocker: MockerFixture, rect: tuple[int, int, int, int]
    ):
        from vrcpilot._win32 import get_window_rect
